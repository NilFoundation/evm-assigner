...
#ifndef EVM_ASSIGNER_EVMC_EVMC_HPP_
#define EVM_ASSIGNER_EVMC_EVMC_HPP_
...
public:
    ...
    bytes32 get_transient_storage(const address& address, const bytes32& key) noexcept final
    {
...
#endif // EVM_ASSIGNER_EVMC_EVMC_HPP_
